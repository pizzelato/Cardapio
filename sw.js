...
self.addEventListener('fetch', e => {
  ...
  // NUNCA cachear o index.html — sempre buscar versão nova
  if(e.request.url.includes('index.html') || e.request.url.endsWith('/Cardapio/') || e.request.url.endsWith('/Cardapio')){
